...
function TermsOfServicePage() {
  return (
    <Card className="p-14 bg-secondary">
      <CardHeader>
        <CardTitle className="">
          <Image
            src={"/images/logo.png"}
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Outsourching, Kota Tangerang Banten
              15810.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Lika Wira Sakti, accessible
              from{" "}
              <a
                href="https://likawirasakti.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://likawirasakti.com
              </a>
            </p>
          </li>
          <li>
      ...
      <CardFooter>
        ...
        <ul>
          <li>By phone number: 6281388029616</li>
        </ul>
      </CardFooter>
    </Card>
  );
